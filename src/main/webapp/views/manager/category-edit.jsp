...
<body>
  <form method="post"
        action="${pageContext.request.contextPath}/manager/category?action=edit"
    ...
    <div class="form-actions">
      ...
      <a href="${pageContext.request.contextPath}/manager/category?action=list" class="btn btn-cancel">✖ Hủy</a>
    </div>
  </form>
